...
function NaverSignupForm({ naverSignup, onSubmit, onUpdate }) {
  const { email, name, extraPassword, extraPasswordConfirm, error } = naverSignup;
...
export default NaverSignupForm; 